...
export default function Middle() {
  const defaultImage = "public/assets/pictures/Gemini_Generated_Image_viqchtviqchtviqc(1).png";
  const hoverImage = "public/assets/pictures/transparent_output(1).png";
